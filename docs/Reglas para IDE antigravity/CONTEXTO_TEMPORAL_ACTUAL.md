...
- Ultimo canon docs-only observado antes de esta reconciliacion: product-surface visual QA fixture discovery, NO-GO / BLOCKED.
- Ultimo resultado aceptado para canonizar: product-surface local fixture harness `2401969`, ACCEPT WITH RESIDUAL RISK.
...
- Skills VSM canonizadas son procedurales, no authoritativas: `vsm-readiness`, `vsm-acceptance-audit`, `vsm-canon-reconciliation` y `vsm-implementation`. En este work-kit son repo procedures bajo `skills/<nombre>/SKILL.md`; no asumir que estan instaladas como Codex runtime/global Skills salvo verificacion explicita del entorno.
