...
- `cff68c1` es prueba local/source para observabilidad de markers publicos no-write; todavia no hay deployed marker availability, freshness check posterior, ni live smoke success.
