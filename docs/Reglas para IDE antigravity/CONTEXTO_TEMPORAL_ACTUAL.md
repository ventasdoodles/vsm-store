...
- Node 24 GitHub Actions residuals: `deploy-pages`, `deploy-functions` y `graqle-sync` tienen runtime proof post-migracion; `ingest-knowledge` fue diff-verified pero no runtime-verified; raw logs no fueron inspeccionados exhaustivamente.
