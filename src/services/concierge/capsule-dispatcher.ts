import {
    executeAuthenticatedLoyaltyStatusCapsule,
    executeAuthenticatedOrderTrackingCapsule,
    executeAuthenticatedWarrantyTriageCapsule,
    executeCartOperatorCapsule,
    executeKnowledgeCapsule,
    executeProductSearchCapsule,
    executeStorefrontBudgetRescueCapsule,
    executeStorefrontCheckoutReadinessCapsule,
    executeStorefrontCompatibilityCheckCapsule,
    executeStorefrontInventoryOutlookCapsule,
    executeStorefrontKittingBasketCapsule,
...
import {
    deriveCheckoutBridgeAction,
    deriveOrderTrackingBridgeAction,
    extractTelemetryNextStepTruth,
    isSearchLeadingIntent,
    resolveGroundedProductSearchMessage,
} from './helpers';
import { logAITelemetry } from './telemetry';
import type {
    ConciergeCatalogGate,
    ConciergeMessage,
    ConciergeProductSearchMemoryContext,
...
export async function dispatchClientCapsule({
    data,
    query,
    history,
    customerProfile,
