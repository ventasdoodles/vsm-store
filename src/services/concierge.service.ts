...
import { executeProductSearchCapsule, executeKnowledgeCapsule, executeCartOperatorCapsule, executeAuthenticatedOrderTrackingCapsule } from '@/services/ai-capsule-orchestrator.service';
