...
const TIER_STYLES: Record<Tier, { bg: string; text: string; border: string; icon: typeof Award }> = {
    ...
    silver: { bg: 'bg-gray-500/20', text: 'text-gray-300', border: 'border-gray-500/30', icon: Shield },
    gold: { bg: 'bg-yellow-500/15', text: 'text-yellow-300', border: 'border-yellow-500/30', icon: Crown },
    platinum: { bg: 'bg-purple-500/15', text: 'text-purple-300', border: 'border-purple-500/30', icon: Diamond },
};
