    ...
    return (
        <>
            ...
            >
                <div 
                    className={cn(
                        'mx-auto flex items-center justify-between gap-4 lg:gap-6 xl:gap-8 transition-all duration-700 relative overflow-visible',
                        scrolled 
                            ? 'h-[64px] max-w-7xl bg-[#0f172a]/70 backdrop-blur-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.7)] border border-white/20 rounded-full px-4 sm:px-6 md:px-8 ring-1 ring-white/10' 
                            : 'h-16 xl:h-[72px] max-w-[90rem] bg-transparent border border-transparent rounded-none px-4 sm:px-6 xl:px-8'
                    )}
                >
                    ...
                    <div className="hidden lg:flex items-center justify-center flex-1 pr-4 xl:pr-8">
                        <DesktopNav />
                    </div>

                    {/* SearchBar — desktop */}
                    <div className="hidden md:block w-full max-w-[200px] lg:max-w-[260px] xl:max-w-xs transition-all duration-300 group">
                        <SearchBar 
                            expandable 
