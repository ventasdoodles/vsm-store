...
export function TopBanner() {
    ...
    return (
        <m.div 
            ...
            className={`relative text-white overflow-hidden text-xs sm:text-sm font-medium tracking-wide z-50 flex justify-center items-center border-b transition-colors duration-1000 ${currentPromo?.urgency ? 'bg-gradient-to-r from-red-950 via-slate-950 to-red-950 border-white/10' : 'bg-slate-950 border-white/5'}`}
        >
