        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-white/5 bg-surface-base/80 backdrop-blur-xl p-6 shadow-2xl group transition-all hover:border-white/10">
            ...
            <div className="relative flex items-center justify-between mb-5">
                ...
                {customer.addresses.length > 1 && (
                    <span className="text-2xs font-bold text-theme-secondary bg-white/5 px-2 py-1 rounded-md border border-white/10">
                        + {customer.addresses.length - 1} alternativas
                    </span>
                )}
            </div>

            <div className="relative z-10 bg-surface-card/50 p-4 rounded-2xl border border-white/5 space-y-2">
