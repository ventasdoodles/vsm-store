...
import { IntelligenceToolRenderer } from './IntelligenceToolRenderer';
import { IntelligenceMessageBubble } from './IntelligenceMessageBubble';
                ...
                <div className="relative overflow-hidden rounded-[2.5rem] border border-vape-500/20 bg-gradient-to-br from-vape-950/40 to-black/40 p-1 backdrop-blur-2xl">
                    ...
                    <div className="relative p-6 px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <IntelligenceToolRenderer 
                                strategicAnalysis={strategicAnalysis}
                                loadingStrategic={loadingStrategic}
                                loadStrategicAI={loadStrategicAI}
                            />
                        </div>

                        {/* Generated WhatsApp Message Preview */}
                        {generatedWhatsApp && (
                            <IntelligenceMessageBubble 
                                intelligence={intelligence}
                                generatedWhatsApp={generatedWhatsApp}
                                setGeneratedWhatsApp={setGeneratedWhatsApp}
                            />
                        )}
                    </div>
                </div>
