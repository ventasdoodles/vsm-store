    ...
    return (
        <div className="relative flex h-screen overflow-hidden bg-[#07070a] text-theme-primary selection:bg-vape-500/30">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                <div className="absolute top-[-10%] right-[-10%] h-[40%] w-[40%] rounded-full bg-vape-600/10 blur-[120px] animate-pulse-slow" />
                <div className="absolute bottom-[-5%] left-[-5%] h-[35%] w-[35%] rounded-full bg-herbal-600/5 blur-[100px] animate-pulse-slow" style={{ animationDelay: '3s' }} />
                <div className="absolute top-[20%] left-[10%] h-[25%] w-[25%] rounded-full bg-vape-400/5 blur-[80px] animate-pulse-slow" style={{ animationDelay: '6s' }} />
            </div>
