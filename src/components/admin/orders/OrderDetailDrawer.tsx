    ...
    return (
        ...
        >
            <div className="space-y-6">
                ...
                <div className="rounded-xl border border-theme/30 bg-theme-secondary/20 p-4">
                    ...
                    <div className="flex gap-3 items-center">
                        <select
                            ...
                            className="flex-1 rounded-lg border border-theme/50 bg-theme-primary px-3 py-2 text-sm text-theme-primary focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
                        >
                ...
                {/* 2. Tracking / EnvÃ­o */}
                <div className="rounded-xl border border-theme/30 bg-theme-primary p-4 space-y-3">
                    ...
                    {isEditingTracking ? (
                        <div className="flex gap-2">
                            <input 
                                ...
                                className="flex-1 rounded-md border border-theme/50 bg-transparent px-3 py-1 text-sm focus:border-primary-500 focus:outline-none text-theme-primary"
                            />
                            <button 
                ...
                <div className="space-y-3">
                    ...
                    <div className="rounded-xl border border-theme/30 bg-theme-primary p-4 text-sm space-y-3">
                        <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="rounded-xl border border-theme/30 bg-theme-primary p-4">
                ...
                <div className="space-y-3">
                    ...
                    <div className="rounded-xl border border-theme/30 bg-theme-primary divide-y divide-theme/20">
                        {order.items?.map((item: any) => (
                            <div key={item.id} className="flex gap-3 p-3">
                                <div className="h-12 w-12 flex-shrink-0 overflow-hidden rounded-md border border-theme/20 bg-theme-secondary/50">
                        ...
                        <div className="p-4 space-y-2 bg-theme-secondary/10 rounded-b-xl">
                            <div className="flex justify-between font-bold text-theme-primary text-lg pt-2 border-t border-theme/20">
                                <span>Total</span>
