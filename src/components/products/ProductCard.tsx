                    ...
                    >
                        ...
                        >
                            ...
                            <div className="absolute top-3 left-3 flex flex-col gap-2 z-10">
                                ...
                                {product.stock === 0 && (
                                    <span
                                        className="px-3 py-1 bg-theme-primary/90 backdrop-blur-md text-red-400 text-xs font-bold tracking-widest uppercase rounded-full shadow-lg border border-red-500/30"
                                    >
                                        AGOTADO
                                    </span>
                                )}
                        ...
                        <div className="p-6 flex-1 flex flex-col relative bg-gradient-to-b from-transparent to-black/20">
                            ...
                            <div className="mt-6 flex items-center justify-between">
                                ...
                                {/* Mini Cart Button — hidden on mobile to avoid duplication with overlay button */}
                                <button
                                    onClick={handleQuickAdd}
                                    disabled={product.stock === 0}
                                    className={cn(
                            ...
                            {!compact && product.stock <= 5 && product.stock > 0 && (
                                <div className="mt-4 flex items-center gap-2 bg-red-500/10 px-3 py-1.5 rounded-lg vsm-border-subtle w-fit animate-pulse-slow" style={{ animationIterationCount: 3 }}>
