...
- `public_web_search` and `public_url_context` now exist as honest reserved capability slots only; they are not an active public-web execution path in the current pilot.
...
- `public_web_search` and `public_url_context` remain reserved slots only; they do not imply active public-web execution in the pilot.
